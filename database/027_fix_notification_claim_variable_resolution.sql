-- =============================================================================
-- OralCardio — 027: define resolução determinística de nomes no claim de Push
-- Depende de 026_fix_notification_delivery_claim_conflict.sql.
--
-- Os nomes das colunas retornadas por RETURNS TABLE são variáveis PL/pgSQL.
-- Como job_id também é uma coluna persistida, o compilador pode considerá-lo
-- ambíguo mesmo em comandos cujo alvo está claro. Esta função sempre pretende
-- resolver esses nomes como colunas SQL; a diretiva abaixo torna isso explícito.
-- =============================================================================
