...
class BrushingService:
    ...
    def mark_zone_completed(
        ...
        validate_zone_transition(set(session.zones_completed), zone)
        return self._repository.update_zones(session_id, user_id, zone)
    ...
    def complete_session(
        ...
        completed = self._repository.complete(session_id, user_id)
